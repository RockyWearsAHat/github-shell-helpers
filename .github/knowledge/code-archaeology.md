...
_"Programs must be written for people to read, and only incidentally for machines to execute." — Harold Abelson. This is aspirational. Most code is written for yesterday's deadline._
