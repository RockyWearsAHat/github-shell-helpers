...
_Sources: Gamma, Helm, Johnson & Vlissides (Design Patterns, 1994), Martin Fowler (Patterns of Enterprise Application Architecture), refactoring.guru, sourcemaking.com_
