...
*Sources: Go Blog ("Share Memory By Communicating"), Rust Book (Fearless Concurrency), Java Concurrency in Practice (Goetz), Erlang documentation (Actor Model), Joe Armstrong (Programming Erlang)*
