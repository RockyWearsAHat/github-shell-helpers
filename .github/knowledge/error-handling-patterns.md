...
3. **Include context.** Error messages should say *what* failed, *why*, and with *what input*.
...
*Sources: andreabergia.com (error handling survey), Rust Book (Result/Option), Go Blog (error handling), MDN (Promise/async-await)*
