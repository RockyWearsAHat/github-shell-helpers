# GitHub - argotorg/solidity: Solidity, the Smart Contract Programming Language · GitHub
...
Source: https://www.openattestation.com/
...
Verified provenance of tamper-proof documents 

Selective Disclosure 
User controls what data to share 

Decentralized Rendering 
Render your document with custom templates 

Verified Issuer's Identity 
Issuers identified with DNS records 

Products built using OpenAttestation 

OpenCerts 

OpenAttestation Gallery 

TradeTrust 

OpenAttestation Wallet (Reference implementation)