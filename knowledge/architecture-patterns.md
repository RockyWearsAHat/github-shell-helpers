...
_Sources: Robert C. Martin (Clean Architecture), Alistair Cockburn (Hexagonal Architecture), Martin Fowler (Microservices, Event Sourcing), Sam Newman (Building Microservices)_
