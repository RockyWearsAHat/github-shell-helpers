...
module.exports = function createResearch(options = {}) {
  ...
  // Session memory is implemented natively (gsh-native) — see lib/mcp-native.js.
  ...
  const knowledgeIndex = createKnowledgeIndex({
    ...
    WORKSPACE_ROOT,
    ...utils,
    fetchCommunityIndex: knowledgeRW.fetchCommunityIndex,
    readKnowledgeFileContent: knowledgeRW.readKnowledgeFileContent,
    searchKnowledgeCache: knowledgeRW.searchKnowledgeCache,
  });

  knowledgeRW.attachKnowledgeIndex({
    buildKnowledgeIndex: (...args) =>
      knowledgeIndex.buildKnowledgeIndex(...args),
